...
namespace frc
{
	namespace robot
	{
		...
		LeftRocketCloseAuto::LeftRocketCloseAuto(Robot *robot) : Autonomous(robot)
		{
		}

		void LeftRocketCloseAuto::init()
		{
		...
		int LeftRocketCloseAuto::winchStart()
		{
		...
		int LeftRocketCloseAuto::winchPeriodic()
		{
			nextStage();
			return 0;
		}

		int LeftRocketCloseAuto::goStart()
		{
		...
		int LeftRocketCloseAuto::goPeriodic()
		{
		...
		int LeftRocketCloseAuto::winchWaitStart()
		{

			return 0;
		}

		int LeftRocketCloseAuto::winchWaitPeriodic()
		{
			if (robot->winchDown->get())
			{ //TODO TRUE GO AWAY ATLAS
				nextStage();
			}
			return 0;
		}

		int LeftRocketCloseAuto::elevatorStart()
		{
		...
		int LeftRocketCloseAuto::elevatorPeriodic()
		{
			nextStage();
		...
		int LeftRocketCloseAuto::secondMoveStart()
		{
			robot->driveLeftEnc.reset();
			robot->driveRightEnc.reset();
		...
		int LeftRocketCloseAuto::secondMovePeriodic()
		{
		...
		int LeftRocketCloseAuto::hatchDownStart()
		{
		...
		int LeftRocketCloseAuto::hatchDownPeriodic()
		{
		...
		int LeftRocketCloseAuto::backStart()
		{
			robot->driveLeftEnc.reset();
			robot->driveRightEnc.reset();
		...
		int LeftRocketCloseAuto::backPeriodic()
		{
		...
		int LeftRocketCloseAuto::lowerStart()
		{
		...
		int LeftRocketCloseAuto::lowerPeriodic()
		{
			nextStage();
			return 0;
		}
